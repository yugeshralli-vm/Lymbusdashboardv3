    ...
    <div className="bg-[#f5f7f7] relative rounded-[12px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] py-[12px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[normal] min-h-px min-w-px not-italic relative text-[#09156a] text-[14px] tracking-[-0.15px] whitespace-pre-wrap">https://api.cgeneral.com/v1</p>
        </div>
      </div>
    </div>
  );
...
function Frame6() {
  return (
    <div className="/ 2] col-[1 content-stretch flex flex-col gap-[8px] items-start relative row-[2] self-start shrink-0 span">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[10px] tracking-[0.5px] uppercase w-full">
        <p className="leading-[normal] whitespace-pre-wrap">Base URL</p>
      </div>
      <TextInput2 />
    </div>
  );
...
function TextInput3() {
  return (
    <div className="bg-[#f5f7f7] relative rounded-[12px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[12px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[normal] min-h-px min-w-px not-italic relative text-[#09156a] text-[14px] tracking-[-0.15px] whitespace-pre-wrap">API Key</p>
          <Icon2 />
        </div>
      </div>
    </div>
...
function Frame8() {
  return (
    <div className="col-[1] content-stretch flex flex-col gap-[8px] items-start relative row-[3] self-start shrink-0">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[10px] tracking-[0.5px] uppercase w-full">
        <p className="leading-[normal] whitespace-pre-wrap">Auth Type</p>
      </div>
      <TextInput3 />
    </div>
  );
...
function TextInput4() {
  return (
    <div className="bg-[#f5f7f7] relative rounded-[12px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] py-[12px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[normal] min-h-px min-w-px not-italic relative text-[#09156a] text-[14px] tracking-[-0.15px] whitespace-pre-wrap">60</p>
        </div>
      </div>
    </div>
  );
...
function Frame9() {
  return (
    <div className="col-[2] content-stretch flex flex-col gap-[8px] items-start relative row-[3] self-start shrink-0">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#6a7282] text-[10px] tracking-[0.5px] uppercase w-full">
        <p className="leading-[normal] whitespace-pre-wrap">Rate Limit (req/min)</p>
      </div>
      <TextInput4 />
    </div>
  );
...
export default function AddDataSourceRestApi() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative rounded-[24px] size-full" data-name="Add Data Source - Rest API">
